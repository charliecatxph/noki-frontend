 ...
 const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
   ...
   const res = await queryClient.fetchQuery({
    ...
    queryFn: async () => {
     const res = await axios.post(`${api}/create-institution`, {
   ...
   <div className={`${poppins.className} min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-indigo-50 flex items-center justify-center p-4`}>
    ...
    >
     ...
     <p className="text-gray-600 mb-4">
      Your Enoki instance for <strong>{formData.schoolName}</strong> has been created.
     </p>
      ...
      <div>
       ...
       <div className="relative">
        ...
        <input
         ...
         className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${errors.schoolName ? 'border-red-300 bg-red-50' : 'border-gray-300'
          }`}
      ...
      <div>
       ...
       <div className="relative">
        ...
        <input
         ...
         className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${errors.ownerName ? 'border-red-300 bg-red-50' : 'border-gray-300'
          }`}
